...
class Tracker():
    def __init__(self, image, target_position, nb_particles = 200):
    ...
    def ParticlesMotionModel(self, stddev = 80):
        self.particles_position += np.random.uniform(-stddev, stddev, self.particles_position.shape)
